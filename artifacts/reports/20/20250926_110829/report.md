...
_Generated: 20250926_110829_

## Executive Summary
6 models executed. Top signal: SepsisEarlyWarning (Prevalence 0.331). Anomalies detected among numeric features. Dataset size: 500 rows.

## Key Findings
- SepsisEarlyWarning Prevalence=0.331
- DiabetesComplicationRisk Prevalence=0.327
- HypertensionControlPredictor Prevalence=0.309
- AKIRiskPredictor Prevalence=0.248
- ICUAdmissionPredictor Prevalence=0.147
...
## Cohorts of Interest
- **Elderly 65+** – age >= 65 — Higher baseline risk
