...
_Generated: 20251114_130158_

## Executive Summary
16 models executed. Top signal: DiabetesComplicationRisk (Prevalence 0.025). Anomalies detected among numeric features. Dataset size: 500 rows.

## Key Findings
- DiabetesComplicationRisk Prevalence=0.025
- AKIRiskPredictor Prevalence=0.021
- SepsisEarlyWarning Prevalence=0.019
- ICUAdmissionPredictor Prevalence=0.019
- MortalityRiskModel Prevalence=0.009
